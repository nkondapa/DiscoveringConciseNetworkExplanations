import numpy as np
import torch
from interpretability_methods_src.pytorch_grad_cam.base_cam import BaseCAM
from interpretability_methods_src.pytorch_grad_cam.utils.find_layers import find_layer_predicate_recursive
from interpretability_methods_src.pytorch_grad_cam.utils.svd_on_activations import get_2d_projection
from interpretability_methods_src.pytorch_grad_cam.utils.image import scale_accross_batch_and_channels, scale_cam_image
    ...
    def compute_cam_per_layer(
        ...
        if eigen_smooth:
            ...
            for i in range(cam_per_target_layer.shape[1]):
                cam_per_target_layer[:, i] = scale_cam_image(
